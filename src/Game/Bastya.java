...
public class Bastya implements SakkBabuk{
    private static final long serialVersionUID = 1L;
    private ImageIcon characterIcon;
    private int color;

    public Bastya(int color){
        this.color = color;
        if(color==0) {
            characterIcon = new ImageIcon("/Users/akosistvanszel/Documents/Java/projekt/src/img/rook.png");
        } else {
            characterIcon = new ImageIcon("/Users/akosistvanszel/Documents/Java/projekt/src/img/wrook.png");
        }
    }
    ...
    public void move(int fromX, int fromY, int toX, int toY) {
        if (isValidMove(fromX, fromY, toX, toY)) {
            System.out.println("A Bástya lép: (" + fromX + "," + fromY + ") -> (" + toX + "," + toY + ")");
        } else {
            System.out.println("Érvénytelen lépés a Bástya számára.");
        }
    }
